...
struct opengl_material
{
  ...
  private:
	...
	bool deserialize_mapping(cParser &Input, int const Priority, bool const Loadnow);
	...
	int m_depth_func_priority = -1;
	int m_depth_mask_priority = -1;
...
class material_manager
{
  ...
  private:
	...
	std::pair<std::string, std::string> find_on_disk(std::string const &Materialname) const;
	// members:
