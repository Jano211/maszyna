...
void main()
{
	...
	vec4 emission_color = texture(emissive, f_coord);
...
//		discard;
	...
	fragcolor = apply_lights_emission(fragcolor, fragnormal, tex_color.rgb, emission_color.rgb, reflectivity, specularity, shadow_tone);
