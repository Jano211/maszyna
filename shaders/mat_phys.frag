...
#texture (params, 1, RGB)
uniform sampler2D params;

#texture (brdf, 2, RG)
uniform sampler2D brdf;

#texture (irradiance, 3, RGB)
uniform samplerCube irradiance;

#texture (radiance, 4, RGB)
...
//		discard;
	...
	vec4 fragcolor = calcColor(vec4(tex_albedo.xyz, tex_albedo.a * alpha_mult), fragnormal, tex_params);
